...
const Navbar = ({
  ...
  const estiloBorder = 'rounded-b-[0.9375rem]';
      ...
      <div className="flex gap-5 items-center justify-between" style={{width: '100%'}}>
        ...
        {link && (
          <div className="links flex gap-5">
            <Link to="/Escolha" className="flex items-center text-sm text-grey-text-light" onClick={(e) => toggleMenu1(e)}>
              Buscar Trabalho
            </Link>
            <Link to="/Escolha" className="flex items-center text-sm text-grey-text-light" onClick={(e) => toggleMenu2(e)}>
              Anunciar Vaga
            </Link>
          </div>
        )}  
