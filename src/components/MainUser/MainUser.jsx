...
>
        <div>
          ...
          />
          <BtnPrincipal
            texto={<div className='flex justify-center gap-2' style={{whiteSpace: 'nowrap'}}>Criar Vaga {selectedButton === 'criarVaga' ? <img src="icons/icon-adc-branco.svg" alt="Minha Imagem"/> : <img src="icons/icon-adc.svg" alt="Minha Imagem"/> }</div>}
        ...
        {selectedButton === 'Edit' &&(
          <div className='centralEditVaga'>
                <EditEmpresa />
                 ...
                 <BtnPrincipal
                 texto={<div className='flex justify-center gap-2'>Editar Vaga {selectedButton === 'Edit'}</div>}
                   back='#3B82F6'
                   padding='15px'
                   borderRadius='25px'
                   color='#fff'
